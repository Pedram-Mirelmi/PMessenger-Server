...
/*
    ...
    response:   {NET_MESSAGE_TYPE: DATA, DATA_TYPE: FETCH_RESULT, PRIVATE_CHATS: [[<ENV_ID>, <LAST_MESSAGE_ID>], ...], GROUP_CHATS: [[<ENV_ID>, <LAST_MESSAGE_ID>], ...], CHANNELS: [[<ENV_ID>, <LAST_MESSAGE_ID>], ...], ...}
*/
...
/*
    ...
    response:   {NET_MESSAGE_TYPE: DATA, DATA_TYPE: PRIVATE_ENV_DETAILS, ENV_INFO: {..., OTHER_PERSON_ID: ...}, OTHER_PERSON_INFO: {...}}
*/
...
/*
    ...
    1-way server message:   {NET_MESSAGE_TYPE: DATA, DATA_TYPE: MESSAGE, TEXT_MESSAGES: [...], ...}
*/
